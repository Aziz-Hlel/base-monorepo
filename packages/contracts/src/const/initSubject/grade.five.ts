...
export const subjectsGradeFive: InitSubjectsPerGradeType[] = [
  { ...baseSubjects.arabic, hoursPerWeek: 1 },
  { ...baseSubjects.french, hoursPerWeek: 1 },
  ...
  { ...baseSubjects.history, hoursPerWeek: 1 },
  { ...baseSubjects.geography, hoursPerWeek: 1 },
  { ...baseSubjects.civic, hoursPerWeek: 1 },
